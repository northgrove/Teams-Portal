...
exports.getToken = () => {
  return async (req, res) => {
    const accessToken = await token.getAccessToken(
      config.tokenURI,
      '1b01bd88-8579-455d-a844-a117c60cebed' //'c46831b2-d939-49eb-b1ea-68e259a90f1d' //process.env['AZURECONFIG_CLIENTID']
    )
...
exports.getTokenOnBehalf = () => {
  return async (req, res) => {
    ...
    const accessToken = await token.getAccessTokenOnBehalf(
      config.tokenURI,
      oldAccessToken,
      '1b01bd88-8579-455d-a844-a117c60cebed' //'e014b351-88c6-4936-be72-321c316b761f'
    )
    res.send(accessToken)
  }
}
...
exports.verifyToken = () => {
  return async (req, res) => {
    ...
    const config = {
      ...
      ISS: 'https://sts.windows.net/596cdefa-aeb5-4122-83b8-ff2da9d9a3d2/',
